# 10.3. Осуществить программу работы с органическими клетками, состоящими из ячеек. Необходимо создать класс «Клетка».
...
class Cell:
    ...
    def __sub__(self, other):
        return Cell(self.units - other.units) if self.units > other.units else None
    ...
    def make_order(self, col):
        s = '*' * self.units
        return '\n'.join([s[i:i + col] for i in range(0, len(s), col)])

    def __str__(self) -> str:
        return f'Cell({self.units})'
